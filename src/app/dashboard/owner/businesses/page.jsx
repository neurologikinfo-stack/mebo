    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-card text-card-foreground rounded-xl shadow border border-border">
        ...
        {businesses.length === 0 && !loading ? (
          <p className="text-muted-foreground">No tienes negocios registrados.</p>
        ) : (
            ...
            <tbody className="divide-y divide-border">
              {businesses.map((b) => (
                <tr
                  ...
                  onClick={() => (window.location.href = `/dashboard/owner/businesses/${b.id}`)}
                >
                  ...
                  {/* Acciones: detenemos propagación */}
